    ...
    <>
      ...
      <div class='py-16'>
        ...
        <div className='mx-auto w-4/5 pt-16'>
          <div class='w-1/3'>
            <div class='border-r border-b border-l border-gray-400 lg:border-t lg:border-gray-400 bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal mb-4'>
              <div class='mb-8'>
